...
p.outputFiles=[arg.input_file.replace('.root','_cluster_11.root')]
p.maxEvents = 1000
p.logFrequency = 100
...
clusters.seed_threshold = 0.60 # MeV
clusters.neighbor_threshold = 0.50 # MeV
clusters.num_neighbors = 8 # number of neighboring strips
